...
// const RECEIVER_EMAIL = process.env.CONTACT_RECEIVER_EMAIL ?? "teammarktaleworld@gmail.com";
// // Path to your PDF inside the public folder
// // const PDF_PATH = path.join(process.cwd(), "public", "guides", "startup-growth-playbook.pdf");
// // const PDF_FILENAME = "Marktale-Startup-Growth-Playbook.pdf";

// // Change these two constants:

// const PDF_PATH = path.join(process.cwd(), "public", "guides", "The Business Growth Blueprint - Marktale.pdf");
// const PDF_FILENAME = "The Business Growth Blueprint - Marktale.pdf";
...
//       console.error("[/api/grow-guide] PDF not found at:", PDF_PATH);
//       return NextResponse.json({ success: false, error: "Guide PDF not found." }, { status: 500 });
//     }
//     const pdfBuffer = fs.readFileSync(PDF_PATH);

//     // Save enquiry to Firestore
//     const db = getAdminDb();
//     const docRef = await db.collection("guide-downloads").add({
//       email,
//       source: "grow-page",
...
//             <h2 style="color:#fff;margin:0;">New Guide Download — MarkTale World</h2>
//           </div>
//           <div style="padding:32px;background:#fafafa;">
//             <p style="color:#333;font-size:16px;">Someone just downloaded the Startup Growth Playbook.</p>
//             <p style="color:#555;"><strong>Email:</strong> ${email}</p>
//             <p style="color:#555;"><strong>Source:</strong> /grow page</p>
//             <p style="color:#999;font-size:12px;">Firestore ID: ${docRef.id}</p>
//           </div>
//         </div>
//       `,
//       attachments: [
...
//     // ── Email to the user with PDF ──
//     await transporter.sendMail({
//       from: `"MarkTale World" <${process.env.GMAIL_USER}>`,
//       to: email,
//       subject: "Your Startup Growth Playbook is here 🚀",
//       html: `
...
//                       <p style="margin:10px 0 0;color:#d1d5db;font-size:14px;">Your Startup Growth Playbook is attached below 👇</p>
//                     </td>
//                   </tr>
//                   <tr>
...
//                         Thanks for downloading the <strong>0 to 10k Users Startup Playbook</strong>.
...
//                         <a href="https://marktaleworld.com/contact"
...
//                       <p style="margin:0;color:#9ca3af;font-size:12px;">MarkTale World · Dwarka, New Delhi</p>
//                     </td>
//                   </tr>
//                 </table>
//               </td>
...
//     // ✅ Respond immediately — user gets success in ~200ms
//     // Heavy work (Firestore + email) runs in the background
//     (async () => {
//       try {
//         if (!fs.existsSync(PDF_PATH)) {
