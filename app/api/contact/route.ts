...
// // app/api/contact/route.ts -priya
// import { NextRequest, NextResponse } from "next/server";
// import { initializeApp, getApps, getApp, cert } from "firebase-admin/app";
// import { getFirestore } from "firebase-admin/firestore";
// import nodemailer from "nodemailer";
...
//     // ✅ FIX 1: services, budget, timeline, company add kiya
//     const { name, phone, email, company, services, budget, timeline, message } = body;
...
//             <tr><td style="padding:10px 0;font-weight:bold;color:#555;">Services</td><td style="padding:10px 0;color:#111;">${services || "—"}</td></tr>
//             <tr><td style="padding:10px 0;font-weight:bold;color:#555;">Budget</td><td style="padding:10px 0;color:#111;">${budget || "—"}</td></tr>
//             <tr><td style="padding:10px 0;font-weight:bold;color:#555;">Timeline</td><td style="padding:10px 0;color:#111;">${timeline || "—"}</td></tr>
//             <tr><td style="padding:10px 0;font-weight:bold;color:#555;vertical-align:top;">Message</td><td style="padding:10px 0;color:#111;">${message || "—"}</td></tr>
//             <tr><td style="padding:10px 0;font-weight:bold;color:#555;">Firestore ID</td><td style="padding:10px 0;color:#999;font-size:12px;">${docRef.id}</td></tr>
//           </table>
//         </div>
...
//       from: `"MarkTale Website" <${process.env.GMAIL_USER}>`,
// to: process.env.CONTACT_RECEIVER_EMAIL,
//       subject: `New Enquiry from ${name} — ${services}`,
//       html: htmlBody,
//     });
...
//                   <p style="margin:8px 0;color:#374151;"><strong>Services:</strong> ${services || "General Enquiry"}</p>
//                   <p style="margin:8px 0;color:#374151;"><strong>Budget:</strong> ${budget || "—"}</p>
//                   <p style="margin:8px 0;color:#374151;"><strong>Timeline:</strong> ${timeline || "—"}</p>
...
//                 <!-- ✅ FIX 2: WhatsApp button hataya, email link lagaya -->
//                 <div style="text-align:center;margin:35px 0;">
...
const RECEIVER_EMAIL = process.env.CONTACT_RECEIVER_EMAIL ?? "marktaleworld@gmail.com";
