...
//           {/* Logo */}
//           <Link href="/" className="relative block w-40 h-12">
//             {/* <Image src="/images/new-logo-Ai-nhi.png" alt="MarkTale" fill className="object-contain" */}
//             <Image src="/images/image.png" alt="MarkTale" fill className="object-contain"
//               sizes="(max-width: 768px) 160px, 160px" />
//           </Link>
...
//                       text-white/10 hover:text-white/25 transition-colors duration-300
//                       focus:outline-none"
//                   >
//                     <ChevronUp size={13} />
//                   </button>
