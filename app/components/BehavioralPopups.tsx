...
// // A live, animated "read" of what's likely holding a business's
// // digital presence back — framed as a signal scan, not a form.
// // ─────────────────────────────────────────────────────────────
...
//  * Pure CSS/Framer transforms, no canvas/WebGL needed.
//  */
...
// /** 3D-tilt finding card — cursor-tracked, matches the site's tilt pattern. */
...
//   // connecting (1.4s) -> reading (steps through checklist) -> findings (2.6s) -> blueprint
//   useEffect(() => {
...
//         setTimeout(step, 480);
//       } else {
//         setTimeout(() => setPhase("findings"), 700);
//       }
//     };
//     step();
//   }, [phase]);
...
//   // Ambient cursor spotlight across the whole card
...
//         {/* Grid backdrop, subtle radar feel */}
//         <div
...
//                   <SignalOrb phase={phase} />
//                   <h2 className="text-[15px] font-black text-white mt-3">
...
//                   <p className="text-[9.5px] text-white/30 uppercase tracking-widest mb-1.5">
//                     Trusted for
//                   </p>
...
//           whileTap={{ scale: 0.95 }}
//           onClick={() => setAgencyOpen(true)}
//           aria-label="See what Aerovince can do"
//           className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white text-[12px] font-bold px-4 py-2.5 rounded-full shadow-lg shadow-blue-200/60 transition-colors"
//         >
//           <Sparkles className="w-3.5 h-3.5" />
//           See what we do
