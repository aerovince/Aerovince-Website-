...
// Maps the string `iconName` on each service to its actual Lucide component.
// Add an entry here any time a new service introduces a new iconName.
    ...
    return (
        <section className="py-24 bg-white">
            <div className="container mx-auto px-6 max-w-7xl">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {services.map((service, index) => {
                        const Icon = ICON_MAP[service.iconName] ?? Search;
