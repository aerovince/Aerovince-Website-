...
//   name: string;
//   badge: string;
//   accent: string; // tailwind gradient classes e.g. "from-blue-500 to-cyan-400"
//   accentSolid: string; // tailwind text color e.g. "text-blue-600"
//   accentBg: string; // tailwind bg color e.g. "bg-blue-50"
//   chartColor: string; // hex for svg stroke
//   bigStatLabel: string;
//   bigStatValue: string;
...
//   pillTwo: { label: string; sub: string; icon: React.ReactNode; color: string };
// }
...
//     pillTwo: { label: "5.0 ⭐ Rating", sub: "98% satisfaction", icon: <Star size={10} className="text-white" />, color: "from-violet-400 to-purple-500" },
//   },
//   {
//     key: "growth",
//     name: "Growth & SEO",
...
//     pillTwo: { label: "5.0 ⭐ Rating", sub: "client trust score", icon: <Star size={10} className="text-white" />, color: "from-cyan-400 to-blue-500" },
//   },
//   {
//     key: "marketing",
...
// /** Cycles through a list of indices on an interval, pausing while `paused` is true. */
...
//           animate={{ x: ["0%", "-50%"] }}
//           transition={{ duration: 22, repeat: Infinity, ease: "linear" }}
//           className="flex gap-8 sm:gap-10 shrink-0"
//         >
//           {[...CLIENT_LOGOS, ...CLIENT_LOGOS].map((name, i) => (
//             <span
//               key={i}
...
// /**
//  * Animated growth chart. Smoothly morphs its path + gradient color whenever
//  * `points` or `color` change, instead of just popping to the new shape.
//  */
...
//         cy={pts[pts.length - 1].y}
//         r="3"
//         animate={{ cx: pts[pts.length - 1].x, cy: pts[pts.length - 1].y, fill: color }}
//         transition={{ duration: 0.7, ease: [0.16, 1, 0.3, 1] }}
//       >
...
// function FloatingDashboard() {
//   const PAUSE_HOVER = useRef(false);
...
//     >
//       {/* Ambient glow — recolors with the active service */}
//       <motion.div
//         animate={{ background: `linear-gradient(135deg, ${panel.chartColor}33, transparent 70%)` }}
...
//             <motion.div
//               animate={{ background: `linear-gradient(135deg, ${panel.chartColor}, ${panel.chartColor}99)` }}
//               transition={{ duration: 0.6 }}
...
//           <motion.div
//             animate={{ background: `linear-gradient(90deg, ${panel.chartColor}14, ${panel.chartColor}08)` }}
//             transition={{ duration: 0.6 }}
...
//                 animate={{ width: `${panel.progressValue}%`, background: panel.chartColor }}
...
//       {/* Radial orbs */}
//       <motion.div
//         className="absolute -top-32 -right-32 w-[400px] sm:w-[600px] lg:w-[700px] h-[400px] sm:h-[600px] lg:h-[700px] rounded-full bg-gradient-to-br from-blue-200/30 via-violet-200/20 to-transparent blur-3xl"
//         animate={{ scale: [1, 1.06, 1], opacity: [0.6, 0.8, 0.6] }}
//         transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }}
//       />
//       <motion.div
//         className="absolute -bottom-24 -left-24 w-[300px] sm:w-[420px] lg:w-[500px] h-[300px] sm:h-[420px] lg:h-[500px] rounded-full bg-gradient-to-tr from-cyan-200/25 via-blue-100/20 to-transparent blur-3xl"
//         animate={{ scale: [1, 1.08, 1], opacity: [0.5, 0.7, 0.5] }}
//         transition={{ duration: 12, repeat: Infinity, ease: "easeInOut", delay: 2 }}
//       />
//       <motion.div
//         className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] sm:w-[650px] lg:w-[800px] h-[260px] sm:h-[330px] lg:h-[400px] rounded-full bg-gradient-to-r from-violet-100/20 to-blue-100/20 blur-3xl"
//         animate={{ rotate: [0, 360] }}
//         transition={{ duration: 60, repeat: Infinity, ease: "linear" }}
//       />
...
//   // Stagger children container — typed explicitly as `Variants` so the
//   // literal `ease` tuple isn't widened to `number[]` by TypeScript.
...
//       <section
//         ref={sectionRef}
//         className="relative min-h-screen flex items-center overflow-hidden pt-20 sm:pt-24 lg:pt-16"
//         aria-label="Hero section"
//       >
//         <HeroBackground />
...
//         <motion.div
//           style={{ y: contentY, opacity: contentOpacity }}
//           className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 lg:py-24"
//         >
...
//               <motion.h1
//                 variants={childVariants}
//                 className="text-4xl sm:text-5xl md:text-6xl lg:text-[68px] xl:text-[76px] font-extrabold text-gray-900 leading-[1.08] sm:leading-[1.05] tracking-tight text-center sm:text-left"
//               >
//                 We Help Brands{" "}
//                 <span className="block mt-1">
//                   <AnimatePresence mode="wait">
...
//               {/* Right column on mobile: show dashboard right after CTAs for small screens */}
...
//           animate={{ opacity: 1 }}
//           transition={{ delay: 3, duration: 0.5 }}
//           className="absolute bottom-4 sm:bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1.5 text-gray-400"
//           aria-hidden="true"
//         >
//           <span className="text-[10px] font-medium tracking-widest uppercase">Scroll</span>
//           <motion.div
