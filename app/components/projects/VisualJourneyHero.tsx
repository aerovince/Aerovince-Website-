...
//         <section className="relative py-16 md:py-32 bg-gradient-to-br from-kestone-black via-gray-900 to-kestone-black overflow-hidden">
...
//                     <motion.h1
//                         // className="text-4xl md:text-7xl lg:text-8xl font-heading font-bold text-white mb-8 leading-tight"
//                         className="text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-heading font-bold text-white mb-8 leading-tight"
...
//                             "This isn&rdquo;t just business. This is our life&rdquo;s work. Every brand we touch becomes part of our legacy.
//                             Every success story fuels our passion. We didn&rdquo;t just restart—we <span className="font-bold text-kestone-red">reignited</span>
