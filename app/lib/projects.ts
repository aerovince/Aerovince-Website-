...
export const projects: Project[] = [
  // ── 1. MentorLeap ─────────────────────────────────────────────────────
  {
    ...
    services: ["Brand Strategy", "Website Design", "SEO", "Growth Marketing", "Content"],
  ...
  // ── 2. Delhi059 ────────────────────────────────────────────────────────
  {
    ...
    services: ["Local SEO", "Google Business", "Social Media", "Community Marketing", "Photography"],
  ...
  // ── 3. Local Ride ──────────────────────────────────────────────────────
  {
    ...
    services: ["Product Strategy", "App Development", "Brand Identity", "Growth Marketing", "Driver Acquisition"],
    technologies: ["React Native", "Node.js", "Firebase", "Stripe", "Google Maps API"],
  },
  ...
  // ── 4. BG Foods ────────────────────────────────────────────────────────
  {
    ...
    services: ["Brand Identity", "E-commerce Build", "Product Photography", "Amazon Listing", "Influencer Marketing"],
  ...
  // ── 5. Dee Cee Accessories ─────────────────────────────────────────────
  {
    ...
    services: ["Product Photography", "Amazon Listing", "Flipkart Listing", "Social Media Setup", "SEO"],
  },
  ...
  // ── 6. CabTale ─────────────────────────────────────────────────────────
  {
    ...
    services: ["App Strategy", "Product Design", "Regional Marketing", "Driver Community", "ASO"],
  ...
  // ── 7. Last Mile Care ──────────────────────────────────────────────────
  {
    ...
    services: ["Website Build", "Impact Storytelling", "Social Media", "CSR Pitch Deck", "Donation Integration"],
  },
];